...
export const MOCK_TRIPS: Trip[] = [
  ...
  {
    id: 'puri-1',
    title: 'Puri Heritage Pilgrimage',
  ...
  {
    id: 'darjeeling-1',
    title: 'Darjeeling Misty Valleys',
  ...
  {
    id: 'purulia-1',
    title: 'Purulia Wilderness Trails',
...
export const MOCK_BLOGS: BlogPost[] = [
  {
    ...
    content: 'Special family and friends discounts are available for all our hubs. Contact us for group rates.',
